...
const isBlockValid = (candidateBlock: Block, preiviousBlock: Block): boolean => {
...
const run = (aData:string) : void => {
    addBlock(creatNewBlock(aData));
}

const genesisBlock: Block = new Block(0, "headHash", "", "first", 1580452900);
